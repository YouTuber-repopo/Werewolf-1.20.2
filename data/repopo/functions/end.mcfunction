...
# 演出
    ...
    execute if predicate repopo:time/night run tellraw @a ["終了: ", {"score": {"objective": "Time", "name": "#Day"}}, "日目 夜"]
    execute unless predicate repopo:time/night run tellraw @a ["終了: ", {"score": {"objective": "Time", "name": "#Day"}}, "日目 昼"]
