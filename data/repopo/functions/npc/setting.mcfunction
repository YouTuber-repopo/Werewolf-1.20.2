...
# 武器鍛冶設定
    ...
    function repopo:npc/item_setting_template { Tp: weapon_smith_setting, Pr: 6, Id: "carrot_on_a_stick", Cn: 1, Nm: '"発光弾"', Lr: '"そこに浮かび上がる何者かのシルエット"', Ei: '""', El: 0, Cm: 7, Dm: 0 }
...
# 道具鍛冶設定
    ...
    function repopo:npc/item_setting_template { Tp: tool_smith_setting, Pr: 10, Id: "heart_of_the_sea", Cn: 1, Nm: '"預言者の心"', Lr: '"神からのお告げを。"', Ei: '""', El: 0, Cm: 0, Dm: 0 }
    function repopo:npc/item_setting_template { Tp: tool_smith_setting, Pr: 5, Id: "carrot_on_a_stick", Cn: 1, Nm: '"遺灰"', Lr: '"死者の痕跡を辿って…"', Ei: '""', El: 0, Cm: 8, Dm: 0 }
